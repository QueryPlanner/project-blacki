...
async def list_models() -> dict:
    """List OpenRouter models for the model picker UI.

    Returns:
        dict with "models" key containing list of {id, name, context_length}.
        On error, returns {"models": [], "error": "message"}.
    """
    from .openrouter import get_models_for_ui
    ...
    try:
        ...
        logging.getLogger(__name__).warning(
            "Failed to list OpenRouter models: %s: %s", type(e).__name__, e
        )
